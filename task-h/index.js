...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    row.innerHTML = `
      <td class="px-3 py-2 border-b border-slate-200">${timestamp}</td>
      <td class="px-3 py-2 border-b border-slate-200">${fullName}</td>
      <td class="px-3 py-2 border-b border-slate-200">${email}</td>
      <td class="px-3 py-2 border-b border-slate-200">${phone}</td>
      <td class="px-3 py-2 border-b border-slate-200">${birthDate}</td>
    `;
